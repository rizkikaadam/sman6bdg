				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="<?php echo base_url(). 'index.php/banner/tambah_aksi'; ?>" method="post">
							  <fieldset>
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="id_banner" >
								  </div>
								</div>   
								<div class="control-group">
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="alt" >
								  </div>
								</div>
								<div class="control-group">
								  <label class="control-label" for="typeahead">Alamat URL</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="url" >
								  </div>
								</div>
								<div class="control-group">
								  <label class="control-label" for="typeahead">Status</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="status" >
								  </div>
								</div>
								<div class="control-group">
