				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon edit"></i><span class="break"></span>Tambah Profil</h2>
						</div>
						<div class="box-content">
							<form class="form-horizontal" action="<?php echo base_url(). 'index.php/profil/tambah_aksi'; ?>" method="post">
							  <fieldset>
								...
								<div class="control-group hidden-phone">
								  ...
								  <div class="controls">
									<textarea class="cleditor" id="textarea2" rows="6" name="isi"></textarea>
								  </div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="link">
								  </div>
								</div>
								<div class="control-group">
								  <label class="control-label" for="typeahead">Urut</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="urut">
								  </div>
								</div>
