				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="<?php echo base_url(). 'index.php/news/tambah_aksi'; ?>" method="post">
							  <fieldset>
								<div class="control-group">
								  <label class="control-label" for="typeahead">id_news</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="id_news" >
								  </div>
								</div>   
								<div class="control-group">
								  <label class="control-label" for="typeahead">Topik</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="subject" >
								  </div>
								</div> 
