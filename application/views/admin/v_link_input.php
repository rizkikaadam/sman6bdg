				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon edit"></i><span class="break"></span>Tambah Link Web</h2>
						</div>
						<div class="box-content">
							<form class="form-horizontal" action="<?php echo base_url(). 'index.php/link/tambah_aksi'; ?>" method="post">
							  <fieldset>
								<div class="control-group">
								  <label class="control-label" for="typeahead">id_link</label>
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="id_link" >
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<input type="text" class="span6 typeahead" id="typeahead" name="alamat" >
								...
								<div class="control-group hidden-phone">
								  ...
								  <div class="controls">
									<textarea class="cleditor" id="textarea2" rows="8" name="ket"></textarea>
								  </div>
								</div>
								<div class="control-group">
