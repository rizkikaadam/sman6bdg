...
<head>
	<!-- Title -->
	<title>Selamat Datang di Website SMAN 6 Bandung</title>
	<!-- Meta -->
	...
	<!-- Bootstrap Core CSS -->
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/bootstrap.css" rel="stylesheet">
	<!-- Template CSS -->
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/animate.css" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/font-awesome.css" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/nexus.css" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/responsive.css" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/umum/css/custom.css" rel="stylesheet">
	<!-- Google Fonts-->
		...
		<div class="row">
			...
			<div class="logo">
				<a href="index.html" title="">
					<img src="<?php echo base_url() ?>/assets/umum/assets/img/logo.png" alt="Logo" />
				</a>
			</div>
			<!-- End Logo -->
			<!-- Top Menu -->
